...
<section id="laporanTransaksi" style="overflow: hidden">
    ...
    <div class="limiter">
        <div class="container-table100" style="display: block; width:100%; overflow:hidden">
            <div class="bungkus" style="width: calc(100vw - 60px); overflow:auto">
                                    ...
                                    <div class="tabel-atas2 row">
                                        <div class="col-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" id="date" name="date" placeholder="Masukan" type="text" />
                                            </div>
